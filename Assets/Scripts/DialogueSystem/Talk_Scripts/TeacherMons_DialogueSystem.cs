...
public class TeacherMons_DialogueSystem : MonoBehaviour
{
    [Header("UI组件")] 
    ...
    void Update()
    {
        ...
        {
            index = 0;
            teacherMons.GetComponent<TeacherMons>().enabled = true;
            dialogueTrigger.GetComponent<TeacherMons_Talk>().willTalk = false;
